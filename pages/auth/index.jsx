    ...
    <section className="max-w-screen block min-h-screen items-center justify-center bg-gmco-grey p-4 md:flex">
      <div className=" relative flex w-full max-w-screen-lg flex-col overflow-hidden rounded-lg bg-cover shadow-lg md:m-10 md:flex-row md:items-center">
        ...
        <Image
          ...
          alt="logo"
          className="absolute  left-5 top-3  w-16 md:inset-x-1/4 md:hidden"
          width={1000}
          height={1000}
        />

        <div className="right-0 mt-7 flex w-full flex-col items-center space-y-8 bg-gmco-white p-4 py-32 backdrop-blur-sm backdrop-filter md:mt-0 md:w-5/12 md:py-40 ">
          <div className="-mt-7 flex flex-col items-center">
            <h1 className="text-gmco-gray mb-3 text-4xl font-bold">
              Selamat Datang
            </h1>
          </div>
          <form
          ...
          >
            <div className="w-full">
              <label className="pl-2 text-base text-slate-500">
                Masukkan email anda
              </label>
            ...
            <label className="my-2 text-center text-sm text-slate-500">
            ...
            <button
              type="submit"
              className="mb-6 w-full rounded-full bg-gmco-yellow-secondary  p-2 font-semibold text-white shadow-md  hover:scale-105 hover:text-gmco-white"
            >
              LOG IN / REGISTER
            </button>
