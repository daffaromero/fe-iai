          ...
          <div className="my-3 flex w-full items-center justify-between pr-2">
            <div className="flex h-10 items-center pl-4">
              <button
                ...
                className="h-full rounded-lg bg-gmco-white p-2 drop-shadow-md duration-300 hover:scale-110 hover:bg-[#00275E]"
              >
                <ArrowPathIcon className="h-full rounded-lg duration-300 hover:rotate-180 hover:text-gmco-white" />
              </button>
              <p
              ...
              {priceCategory.map((namePrice) => (
                <div className="group relative flex border-b-4 border-gmco-grey border-opacity-40">
                  ...
                  >
                    ...
                    ></span>
                    <span
                      className={`absolute inset-0 w-full border-2 border-black transition duration-200 ease-out group-hover:bg-gmco-yellow-secondary ${
                        priceCategoryHighlight.includes(namePrice.price)
                          ? "bg-gmco-yellow-secondary"
                    ...
                    ></span>
                    <span
                      className={`relative text-gmco-white transition duration-200 ease-out group-hover:text-gmco-white ${
                        priceCategoryHighlight.includes(namePrice.price)
                          ? "text-gmco-white"
                          : priceCategoryHoverHighlight.includes(
                              namePrice.price
